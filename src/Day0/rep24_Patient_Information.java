...
Married?: true
 */
public class rep24_Patient_Information {
    public static void main(String[] args) {
        ...
        long workPhoneNumer = scan.nextLong();
        System.out.println("Enter your personal phone number");
        long personalPhoneNumer = scan.nextLong();
        ...
        String contacts = "work phone number" + " - " + workPhoneNumer+ ", " + "personal phone number" + " - " +
                personalPhoneNumer + ", " + "email: " + email;
