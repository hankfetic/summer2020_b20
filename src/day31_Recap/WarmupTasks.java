...
/*
1.  write a return method called frequency that accepts two parameters: string str and char ch, the method returns the
 8      frequency of the ch from the str as an int
			Ex:
				frequency("AAA", 'A') ==>  3
				frequency("ABAB", 'B') ==> 2
